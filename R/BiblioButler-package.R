...
#'
#' @section Main functions: \itemize{ \item \code{\link{collect_references}}:
#'   Collect references from a specified source \item [Add more main functions
